...
export const ModelDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="imageAiApp.model.delete.question">
        <Translate contentKey="imageAiApp.model.delete.question" interpolate={{ id: modelEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="bpf-confirm-delete-model" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
