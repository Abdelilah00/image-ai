...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './model.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_MODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MODEL actions', async () => {
      const expectedActions = [
        {
