  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="imageAiApp.model.home.createOrEditLabel" data-cy="ModelCreateUpdateHeading">
            <Translate contentKey="imageAiApp.model.home.createOrEditLabel">Create or edit a Model</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('imageAiApp.model.name')}
                id="model-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('imageAiApp.model.version')}
                id="model-version"
                name="version"
                data-cy="version"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('imageAiApp.model.feePerSecond')}
                id="model-feePerSecond"
                name="feePerSecond"
                data-cy="feePerSecond"
                type="text"
                validate={{
                  required: { value: true, message: translate('entity.validation.required') },
              ...
              />
              <ValidatedField
                label={translate('imageAiApp.model.displayName')}
