...
export const HistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="imageAiApp.history.delete.question">
        <Translate contentKey="imageAiApp.history.delete.question" interpolate={{ id: historyEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="bpf-confirm-delete-history" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
