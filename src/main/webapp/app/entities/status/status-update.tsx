  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="imageAiApp.status.home.createOrEditLabel" data-cy="StatusCreateUpdateHeading">
            <Translate contentKey="imageAiApp.status.home.createOrEditLabel">Create or edit a Status</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('imageAiApp.status.name')}
                id="status-name"
                name="name"
                data-cy="name"
                type="text"
